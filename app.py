...
# Title & Instructions
st.markdown("<h1 style='text-align: center; font-size: 40px;'>💓 Heart Disease Predictor</h1>", unsafe_allow_html=True)
st.markdown("<p style='text-align: center; font-size: 18px;'>Enter patient information below to estimate the risk of heart disease.</p>", unsafe_allow_html=True)
st.markdown("---")

# Input fields with larger font and intuitive options
